...
/*!
 * \file tests/rpc/asio/protobuf/Test2ServiceImpl.h
...
#ifndef __CASOCKLIB__TESTS_RPC_ASIO_PROTOBUF__TEST2_SERVICE_IMPL_H_
#define __CASOCKLIB__TESTS_RPC_ASIO_PROTOBUF__TEST2_SERVICE_IMPL_H_
...
namespace tests {
  namespace rpc {
    namespace asio {
      namespace protobuf {
        class Test2ServiceImpl : public tests::rpc::protobuf::api::TestService
        {
          public:
          ...
          public:
            ...
            {
              LOGMSG (LOW_LEVEL, "Test2ServiceImpl::%s () - request->message () [%u]\n", __FUNCTION__, request->message ());
            ...
            void TestShutdown(::google::protobuf::RpcController* controller,
                const tests::rpc::protobuf::api::TestRequest* request,
                tests::rpc::protobuf::api::TestResponse* response,
                ::google::protobuf::Closure* done)
            {
...
#endif // __CASOCKLIB__TESTS_RPC_ASIO_PROTOBUF__TEST2_SERVICE_IMPL_H_
