...
#ifndef __CASOCKLIB__TESTS_RPC_PROTOBUF_CLIENT__RPC_CALL_HANDLER_FACTORY_MOCK_H_
#define __CASOCKLIB__TESTS_RPC_PROTOBUF_CLIENT__RPC_CALL_HANDLER_FACTORY_MOCK_H_
...
#endif // __CASOCKLIB__TESTS_RPC_PROTOBUF_CLIENT__RPC_CALL_HANDLER_FACTORY_MOCK_H_
