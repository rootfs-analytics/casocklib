...
#ifndef __CASOCKLIB__EXAMPLES_PROACTOR_ASIO_FTP_FTP_FILE_H_
#define __CASOCKLIB__EXAMPLES_PROACTOR_ASIO_FTP_FTP_FILE_H_
...
#endif // #define __CASOCKLIB__EXAMPLES_PROACTOR_ASIO_FTP_FTP_FILE_H_
