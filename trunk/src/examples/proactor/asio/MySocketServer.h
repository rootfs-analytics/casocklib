...
#ifndef __CASOCKLIB__EXAMPLES_PROACTOR_ASIO_MY_SOCKET_SERVER_H_
#define __CASOCKLIB__EXAMPLES_PROACTOR_ASIO_MY_SOCKET_SERVER_H_
...
#endif // __CASOCKLIB__EXAMPLES_PROACTOR_ASIO_MY_SOCKET_SERVER_H_
