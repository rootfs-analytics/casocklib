...
/*!
 * \file casock/base/FileDescriptor.h
...
#ifndef __CASOCKLIB__CASOCK_BASE_FILE_DESCRIPTOR_H_
#define __CASOCKLIB__CASOCK_BASE_FILE_DESCRIPTOR_H_
...
#endif // __CASOCKLIB__CASOCK_BASE_FILE_DESCRIPTOR_H_
