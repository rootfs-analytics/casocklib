...
#ifndef __CASOCKLIB__CASOCK_BASE_DISPATCHER_H_
#define __CASOCKLIB__CASOCK_BASE_DISPATCHER_H_

#include <unistd.h>
#include <signal.h>
#include <time.h>

#include "casock/base/FDHandlerHash.h"
...
//        static struct sigaction m_sigaction;
//        static struct sigaction m_sigaction2;
...
#endif // __CASOCKLIB__CASOCK_BASE_DISPATCHER_H_
