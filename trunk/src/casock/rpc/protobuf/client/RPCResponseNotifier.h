...
#ifndef __CASOCKLIB__CASOCK_RPC_PROTOBUF_CLIENT_RPC_RESPONSE_NOTIFIER_H_
#define __CASOCKLIB__CASOCK_RPC_PROTOBUF_CLIENT_RPC_RESPONSE_NOTIFIER_H_
...
#endif // __CASOCKLIB__CASOCK_RPC_PROTOBUF_CLIENT_RPC_RESPONSE_NOTIFIER_H_
