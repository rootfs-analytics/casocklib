...
/*!
 * \file casock/rpc/protobuf/server/RPCServerCommunicator.cc
...
namespace casock {
  namespace rpc {
    namespace protobuf {
      namespace server {
        RPCServerCommunicator::RPCServerCommunicator (const casock::base::FileDescriptor* const pFD) : casock::rpc::protobuf::base::RPCCommunicator (pFD)
        {
        }
