...
#ifndef __CASOCKLIB__CASOCK_SERVER_CAS_SERVER_EXCEPTION_H_
#define __CASOCKLIB__CASOCK_SERVER_CAS_SERVER_EXCEPTION_H_
...
#endif // __CASOCKLIB__CASOCK_SERVER_CAS_SERVER_EXCEPTION_H_
