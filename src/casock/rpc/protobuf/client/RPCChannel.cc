...
/*!
 * \file casock/rpc/protobuf/client/RPCChannel.cc
...
namespace casock {
  namespace rpc {
    namespace protobuf {
      namespace client {
        RPCChannel::RPCChannel (casock::rpc::protobuf::base::RPCCommunicator* pCommunicator) : mpCommunicator (pCommunicator)
        {
