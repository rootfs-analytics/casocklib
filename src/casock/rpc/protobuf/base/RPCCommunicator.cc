...
/*!
 * \file casock/rpc/protobuf/base/RPCCommunicator.cc
      ...
      namespace base {
        ...
        google::protobuf::Message* RPCCommunicator::read ()
        {
          ...
          if (buffer.str ().length () < (size_t) size)
            throw (CASRPCUnfinishedMessageException ());
        ...
        void RPCCommunicator::write (const google::protobuf::Message* message)
        {
